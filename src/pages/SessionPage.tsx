...
import type { SessionState, Checkpoint, DeletionEpisode, EnhanceResponse } from '@shared/types';
import { Button } from '@/components/ui/button';
import { Textarea } from '@/components/ui/textarea';
import { Brain, Save, Sparkles, History, ArrowLeft, CheckCircle2 } from 'lucide-react';
...
export function SessionPage() {
  ...
  if (isLoading) return <AppLayout container><div className="font-display text-2xl">Loading Workspace...</div></AppLayout>;
        ...
        <div className="w-96 flex flex-col bg-paper overflow-y-auto">
          <div className="p-6 space-y-8">
            ...
            <section className="space-y-4">
              ...
              {isEnhancing ? (
                <div className="illustrative-card border-dashed bg-white animate-pulse">
                  Delta is searching episodes...
                </div>
              ) : enhanceData ? (
            ...
            <section className="space-y-4">
              ...
              <div className="space-y-3">
                {session.checkpoints.slice().reverse().map((cp) => (
                  <div key={cp.id} className="illustrative-card bg-white p-3 hover:bg-accent cursor-pointer transition-colors group">
